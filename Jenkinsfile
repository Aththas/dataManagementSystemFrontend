pipeline {
  environment {
     ENV="stg"   //Change the environment accordingly ex: stg for staging and  pr for production
 	 ...
 	 APP_NAME = "mob-datamgmt-fr"      //Change the application name , which will also be the deployment name
     ...
     EXPOSE_PORT="3000"                    //Change the service expose port accordingly
