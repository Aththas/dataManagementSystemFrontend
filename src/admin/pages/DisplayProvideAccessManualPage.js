...
import ProvideAccessManualForm from '../components/Access-Management/AccessByManual/ProvideAccessManualForm';

const DisplayProvideAccessManualPage = () => {
  ...
  return (
    <div className="container">
      ...
      <div className="main">
        <Topbar />
        <ProvideAccessManualForm />
      </div>
    </div>
  );
};

export default DisplayProvideAccessManualPage;
