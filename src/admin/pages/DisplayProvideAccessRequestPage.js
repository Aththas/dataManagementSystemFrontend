...
import ProvideAccessRequestForm from '../components/Access-Management/AccessByRequest/ProvideAccessRequestForm';

const DisplayProvideAccessRequestPage = () => {
  ...
  return (
    <div className="container">
      ...
      <div className="main">
        <Topbar />
        <ProvideAccessRequestForm />
      </div>
    </div>
  );
};

export default DisplayProvideAccessRequestPage;
