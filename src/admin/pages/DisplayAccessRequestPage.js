...
import AccessRequestForm from '../components/Access-Management/RequestAccess/AccessRequestForm';

const DisplayAccessRequestPage = () => {
...
export default DisplayAccessRequestPage;
